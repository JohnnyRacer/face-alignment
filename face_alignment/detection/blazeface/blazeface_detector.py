...
models_urls = {
    'blazeface_weights_fr': 'https://github.com/hollance/BlazeFace-PyTorch/blob/master/blazeface.pth?raw=true',
    'blazeface_anchors_fr': 'https://github.com/hollance/BlazeFace-PyTorch/blob/master/anchors.npy?raw=true',
    'blazeface_weights_bk': 'https://github.com/hollance/BlazeFace-PyTorch/blob/master/blazefaceback.pth?raw=true',
    'blazeface_anchors_bk': 'https://github.com/hollance/BlazeFace-PyTorch/blob/master/anchorsback.npy?raw=true'
}
...
class BlazeFaceDetector(FaceDetector):
    def __init__(self, device, path_to_detector=None, path_to_anchor=None, verbose=False,
        ...
        if path_to_detector is None:
            model_weights = load_url(models_urls['blazeface_weights_bk'] if back_model else  models_urls['blazeface_weights_fr']  )
            model_anchors = np.load(load_file_from_url(models_urls['blazeface_anchors_bk'] if back_model else models_urls['blazeface_anchors_fr']))
        else:
